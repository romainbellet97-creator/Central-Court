...
const styles = StyleSheet.create({
  ...
  weekCard: { width: 180, backgroundColor: '#fff', borderRadius: 16, padding: 16, marginRight: 12, marginLeft: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3, borderWidth: 1, borderColor: '#E5E7EB' },
  weekCardSummary: { width: 180, backgroundColor: '#fff', borderRadius: 16, padding: 16, marginRight: 12, marginLeft: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3, borderWidth: 1, borderColor: '#8B5CF630' },
  weekCardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  weekNumber: { fontSize: 13, fontWeight: '700', color: '#1e3c72', backgroundColor: '#1e3c7212', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  weekDates: { fontSize: 11, color: '#6B7280', fontWeight: '500' },
  weekCardBlocked: { opacity: 0.5, backgroundColor: '#F9FAFB' },
  multiTournamentBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#8B5CF615', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, marginBottom: 8, gap: 6 },
  multiTournamentText: { fontSize: 12, fontWeight: '600', color: '#8B5CF6' },
  multiTournamentBadgeLarge: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#8B5CF618', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, marginBottom: 12, gap: 8, borderWidth: 1, borderColor: '#8B5CF630' },
  multiTournamentTextLarge: { fontSize: 15, fontWeight: '700', color: '#7C3AED' },
  locationChips: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 12 },
  locationChip: { backgroundColor: '#F3F4F6', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, borderWidth: 1, borderColor: '#E5E7EB' },
  locationChipText: { fontSize: 12, color: '#4B5563', fontWeight: '500' },
  locationChipMore: { backgroundColor: '#E5E7EB', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  locationChipMoreText: { fontSize: 12, color: '#6B7280', fontWeight: '600' },
  viewDetailBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1e3c7210', paddingVertical: 12, borderRadius: 10, gap: 6, borderWidth: 1, borderColor: '#1e3c7220' },
  ...
  tournamentName: { fontSize: 16, fontWeight: '700', color: '#1a1a1a', marginBottom: 10 },
  tournamentMeta: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  surfaceBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  surfaceText: { fontSize: 11, fontWeight: '600' },
  tournamentLocation: { fontSize: 13, color: '#4B5563', flex: 1, fontWeight: '500' },
  prizeRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10, gap: 6, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#F3F4F6' },
  weekPrizeText: { fontSize: 14, fontWeight: '700', color: '#1e3c72' },
  registrationBadge: { flexDirection: 'row', alignItems: 'center', marginTop: 12, gap: 6, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10 },
  ...
  // Tournament Detail Modal - AMÉLIORATION HOMOGÉNÉITÉ
  tournamentDetail: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, marginBottom: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1, borderWidth: 1, borderColor: '#E5E7EB' },
  tournamentHidden: { opacity: 0.5, backgroundColor: '#F9FAFB', borderColor: '#E5E7EB' },
  tournamentDetailHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 8 },
  tournamentDetailFlag: { fontSize: 32 },
  tournamentDetailName: { fontSize: 17, fontWeight: '700', color: '#1a1a1a', marginBottom: 2 },
  tournamentDetailMeta: { fontSize: 13, color: '#6B7280', marginBottom: 2 },
  tournamentDetailRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#F3F4F6' },
  prizeText: { fontSize: 15, fontWeight: '700', color: '#1e3c72' },
  currentStatusRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 12, marginBottom: 4, backgroundColor: '#F0F9FF', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, alignSelf: 'flex-start' },
  currentStatusText: { fontSize: 13, fontWeight: '600', color: '#0369A1' },
  ...
  notInterestedText: { fontSize: 13, color: '#9CA3AF', fontWeight: '500' },
  unhideBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 14, paddingVertical: 12, backgroundColor: '#EEF2FF', borderRadius: 10, borderWidth: 1, borderColor: '#C7D2FE' },
  unhideBtnText: { fontSize: 14, color: '#4F46E5', fontWeight: '600' },
